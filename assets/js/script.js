  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    sb.reveal('.hero_container .col:nth-child(2),.header_left,.faq_content_container .col:nth-child(2) .faq_collapse,.about_hero_container .col:nth-child(2),.contact_container .col:nth-child(2)',{ origin: 'right' });
    sb.reveal('.categories_card,.course_card,.testimonials_content, .footer_logo_container,.footer_list_container,.social_media_btn,adress,.team_card,.pagination_container button,.map',{ origin: 'bottom' });
